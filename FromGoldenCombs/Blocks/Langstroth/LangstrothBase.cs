...
namespace VFromGoldenCombs.Blocks.Langstroth
{
    class LangstrothBase : LangstrothCore
    {
        ...
        {
            return GetBlockEntity<BELangstrothBase>(pos)?.getOrCreateSelectionBoxes() ?? base.GetSelectionBoxes(blockAccessor, pos);
        }
        ...
        public override bool DoPlaceBlock(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ItemStack byItemStack)
        {
            ...
            if (num && world.BlockAccessor.GetBlockEntity(blockSel.Position) is BELangstrothBase beLangstrothBase)
            {
                ...
                beLangstrothBase.MeshAngleRad = meshAngleRad;
                beLangstrothBase.OnBlockPlaced(byItemStack);
            }
        ...
        {
            Dictionary<string, MeshData> orCreate = ObjectCacheUtil.GetOrCreate(api, "langstrothbaseMeshes", () => new Dictionary<string, MeshData>());
            ...
            if (overrideTexturesource != null || !orCreate.TryGetValue(key, out var modeldata))
            {
                ...
                coreClientAPI.Tesselator.TesselateShape("LangstrothBase block", shape, out modeldata, texPositionSource, null, 0, 0, 0);
        ...
        {
            BELangstrothBase blockEntity = GetBlockEntity<BELangstrothBase>(pos);
            if (blockEntity != null)
            {
        ...
        public override void OnBeforeRender(ICoreClientAPI capi, ItemStack itemstack, EnumItemRenderTarget target, ref ItemRenderInfo renderinfo)
        {
            ...
            Dictionary<string, MultiTextureMeshRef> orCreate = ObjectCacheUtil.GetOrCreate(capi, "LangstrothBaseMeshesInventory", () => new Dictionary<string, MultiTextureMeshRef>());
        ...
        public override ItemStack OnPickBlock(IWorldAccessor world, BlockPos pos)
        {
            ...
            if (world.BlockAccessor.GetBlockEntity(pos) is BELangstrothBase beLangstrorthBase)
            {
                itemStack.Attributes.SetString("type", beLangstrorthBase.Type);
                itemStack.Attributes.SetString("material", beLangstrorthBase.Material);
                itemStack.Attributes.SetString("material2", beLangstrorthBase.Material2);
            }
