...
namespace FromGoldenCombs.Blocks.Langstroth
{
    class LangstrothStack : LangstrothCore
    {
        ...
        public void LoadTypes()
        {
            ...
            #region This code is likely unnecessary for the Langstroth Stack
            ...
            //}
            #endregion
            #region This section is all about putting stuff in the creative menu... Do not need.
        ...
        //{
        //    return GetBlockEntity<BELangstrothStack>(pos)?.getOrCreateSelectionBoxes() ?? base.GetSelectionBoxes(blockAccessor, pos);
        //}
        ...
        //{
        //    BELangstrothStack blockEntity = GetBlockEntity<BELangstrothStack>(pos);
        //    if (blockEntity != null)
        //    {
        //        float[] values = Matrixf.Create().Translate(0.5f, 0.5f, 0.5f).RotateY(blockEntity.MeshAngleRad)
        //            .Translate(-0.5f, -0.5f, -0.5f)
        //            .Values;
        //        blockModelData = GetOrCreateMesh(blockEntity.Type).Clone().MatrixTransform(values);
        //        decalModelData = GetOrCreateMesh(blockEntity.Type, decalTexSource).Clone().MatrixTransform(values);
        //    }
        //    else
        //    {
        ...
        public override ItemStack OnPickBlock(IWorldAccessor world, BlockPos pos)
        {
            ...
            if (world.BlockAccessor.GetBlockEntity(pos) is BELangstrothStack beLangstrothStack)
            {
                //itemStack.Attributes.SetString("type", beLangstrothStack.Type);
