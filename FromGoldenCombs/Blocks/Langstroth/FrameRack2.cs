...
{
    class FrameRack2 : LangstrothCore
    {
        ...
        {
            return GetBlockEntity<BEFrameRack2>(pos)?.getOrCreateSelectionBoxes() ?? base.GetSelectionBoxes(blockAccessor, pos);
        }
        ...
        public override bool DoPlaceBlock(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ItemStack byItemStack)
        {
            ...
            if (num && world.BlockAccessor.GetBlockEntity(blockSel.Position) is BEFrameRack2 beFrameRack2)
            {
        ...
        public override ItemStack OnPickBlock(IWorldAccessor world, BlockPos pos)
        {
            ...
            if (world.BlockAccessor.GetBlockEntity(pos) is BEFrameRack2 beFrameRack2)
            {
        ...
        {
            BEFrameRack2 beFrameRack = (BEFrameRack2)world.BlockAccessor.GetBlockEntity(blockSel.Position) as BEFrameRack2;

            if (beFrameRack is BEFrameRack2)
            {
